"""
Django settings for PARK_INFO project.
...
CSRF_TRUSTED_ORIGINS = [
    'https://a3ac-41-79-239-116.ngrok-free.app',
]

ROOT_URLCONF = 'PARK_INFO.urls'
...
WSGI_APPLICATION = 'PARK_INFO.wsgi.application'
